...
#include "ChemicodePrototype/ChemicodeSearchableComboBox.h"
#include "Components/Widget.h"
#include "SearchableComboBox.generated.h"

/**
 * Combo box that can be searched.
 */
UCLASS()
class CHEMICODEPROTOTYPE_API USearchableComboBox : public UWidget
{
...
protected:
	...
	TSharedPtr<SChemicodeSearchableComboBox> MyComboBox;
